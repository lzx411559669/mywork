                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <div style="margin-left: 1000px">
		                           <a  href="tests.do?show&index=1">第一页</a>
		                           <c:if test="${total>index}">
		                           <a href="tests.do?show&index=${index+1}">下一页</a>
		                           </c:if>
		                           <c:if test="${index>1}">
		                           <a href="tests.do?show&index=${index-1}">上一页</a>
		                           </c:if>
		                           <a href="tests.do?show&index=${total}">最后一页</a>
		                       </div>
		                       <!-- 翻页 -->
                            </div>
                        </div>
...
<!-- 添加模态框 -->
            <form action="tests.do?addTests" method="post">
