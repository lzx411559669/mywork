...
function check(){
	...
	$.ajax({
		url:'teacher.do?login&tid='+tid+'&tpwd='+tpwd,
		type:'post',
                ...
                <div class="card p-4">
                    ...
                    <div class="card-body py-5">
                        <div class="form-group">
                            ...
                            <input id="tid" required="required" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label class="form-control-label">密码</label>
                            <input id="tpwd" required="required" type="password" class="form-control">
                        </div>
