...
function edit(data){
	var xztno=$(data).attr("id");
	$.ajax({
		url:'xzt.do?findByXztno',//访问地址
		data:'xztno='+xztno,//传参数
		dataType:'json',//数据类型
		type:'post',//提交方式
		success:function(result){//回调函数
			if(result!=null){
				$("#xztno").val(result.xztno);
				$("#xztnr").val(result.xztnr);
				$("#val").val(result.val);
				$("#a").val(result.a);
				$("#b").val(result.b);
				$("#c").val(result.c);
 ...
 <div class="sidebar">
	...
	<div class="content">
		<div style="height:50px">
			<form class="form-inline" action="xzt.do?findXzt" method="post">
				<div>
				...
				<div style="margin-left:800px">
						<input type="text" required="required" class="form-control" id="name" placeholder="请输入搜索内容" name="xztnr">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <c:forEach items="${list}" var="x">
				                      <tr>
				                           ...
				                           <a type="button" class="btn btn-danger" href="javascript:if(confirm('是否要删除'))location='xzt.do?delXzt&xztno=${x.xztno}'">
				                         	  删除
				                           </a>
				                           
				                           <a onclick="edit(this)" id="${x.xztno}" type="button" class="btn btn-info" data-toggle="modal" data-target="#editmo">
				                           	修改
				                           </a>
                                ...
                                <div style="margin-left: 1000px">
		                           <a  href="xzt.do?showxzt&index=1">第一页</a>
		                           <c:if test="${total>index}">
		                           <a href="xzt.do?showxzt&index=${index+1}">下一页</a>
		                           </c:if>
		                           <c:if test="${index>1}">
		                           <a href="xzt.do?showxzt&index=${index-1}">上一页</a>
		                           </c:if>
		                           <a href="xzt.do?showxzt&index=${total}">最后一页</a>
		                       </div>
		                       <!-- 翻页 -->
                            </div>
                        </div>
...
<!-- 添加模态框 -->
            <form action="xzt.do?addXzt" method="post">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="firstname" placeholder="题干" name="xztnr" > 
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="firstname" placeholder="A" name="a" > 
										</div>
									</div>
									<div class="form-group">
										<label for="lastname" class="col-sm-2 control-label">B</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="lastname" placeholder="B" name="b">
										</div>
									</div>
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">C</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="firstname" placeholder="C" name="c" > 
										</div>
									</div>
									<div class="form-group">
										<label for="lastname" class="col-sm-2 control-label">D</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="lastname" placeholder="D" name="d">
										</div>
									</div>
									<div class="form-group">
										<label for="lastname" class="col-sm-2 control-label">答案</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="lastname" placeholder="答案" name="answer">
										</div>
									</div>
									<div class="form-group">
...
<!-- 修改模态框 -->
					<form action="xzt.do?updateXzt" method="post">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="form-group">
										...
										<div class="col-sm-10">
											<input class="form-control" id="xztno" type="text" readonly = "readonly"  name="xztno">
										</div>
								</div>
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">题干</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="xztnr" placeholder="题干" name="xztnr" > 
										</div>
									</div>
									<div class="form-group">
										<label for="lastname" class="col-sm-2 control-label">分值</label>
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">A</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="a" placeholder="A" name="a" > 
										</div>
									</div>
									<div class="form-group">
										<label for="lastname" class="col-sm-2 control-label">B</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="b" placeholder="B" name="b">
										</div>
									</div>
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">C</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="c" placeholder="C" name="c" > 
										</div>
									</div>
									<div class="form-group">
										<label for="lastname" class="col-sm-2 control-label">D</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="d" placeholder="D" name="d">
										</div>
									</div>
									<div class="form-group">
										<label for="lastname" class="col-sm-2 control-label">答案</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" required="required" id="answer" placeholder="答案" name="answer">
										</div>
									</div>
									<div class="form-group">
										<label for="name">选择学科</label>
